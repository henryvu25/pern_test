import React, { Fragment, useState } from "react"; //useState keeps track of data

const EditTodo = ({ todo }) => { //{todo} is fetched from ListTodos.js
    ...
    return (
        ...
        <button type="button" class="btn btn-warning" data-toggle="modal" data-target={`#id${todo.todo_id}`}> {/* # is for targeting the id */}
            Edit
        </button>


        <div class="modal" id={`id${todo.todo_id}`} onClick={() => setDescription(todo.description)}> {/* id= id1 for example */}
